          ...
          <div class="media_left">
            <div class="warp_selected_date_screen_3">
              <div class="title">Укажите данные всех участников</div>
                ...
                <div class="row">
                  <div class="col-12 col-lg-6 d-flex flex-column mb-4" v-for="(item, index) in participant" :key="index">
          ...
          <div class="media_left">
            <div class="warp_selected_date_screen_3">
              ...
              <div class="row">
                ...
                <div class="warp_input">
                  <input class="formInput" name="promo" placeholder="Введите промокод (если есть)" type="text" />
                </div>
              </div>
              <div class="row">
                <div class="price">
...
export default {
  ...
  methods: {
    ...
    onSubmit(event) {
      ...
      axios.post("https://script.kdm1.ru/vdk/post.php", {
        formData
      })
          .then((response) => {
